...
public class GamesController: ControllerBase
{
    ...
    {
        var game = GamesStore.Games.FirstOrDefault(game => game.Id == id);
        if (game is null)
        {
    ...
    [HttpGet("favourites")]
    public ActionResult<List<Game>> GetFavorites()
    {
        var favouriteGames = GamesStore.Games.Where(g => g.IsFavourite).ToList();
        return Ok(favouriteGames);  
    }
}